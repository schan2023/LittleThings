...
class DisplayFavoritedDayViewController: UIViewController {
    ...
    private func setConstraints() {
        ...
        favoritedEventDateLabel.snp.makeConstraints { (make) in
            let eventDateHeight = screenHeight * 0.1127
        ...
        lineView.snp.makeConstraints{ (make) in
            ...
            make.top.equalTo(favoritedEventDateLabel.snp.bottom).offset(8)
            make.left.equalToSuperview().offset(15)
            make.right.equalToSuperview().offset(-15)
        }
        
        collectionView.snp.makeConstraints { (make) in
            let collectionViewHeight = screenHeight * 0.451
            make.height.equalTo(collectionViewHeight)
            make.top.equalTo(lineView.snp.bottom).offset(53.33)
        ...
        homeBtn.snp.makeConstraints { (make) in
            ...
            make.left.equalToSuperview().offset(147.67)
            make.right.equalToSuperview().offset(-146.33)
